    ...
    <div className="flex-col mt-4 ml-7">
      ...
      <div className="py-12 px-72">
        ...
        <div className="mt-10 relative">
          ...
          {data && <div className="absolute font-extralight bottom-12 ml-11 text-white">
            {data.weather[0].main}
          </div>}
        </div>
        ...
        <div className="flex mt-5 justify-between">
          ...
          {data && <p className="mr-5 text-gray-800">{data.main.pressure}hPa</p>}
        </div>

        <div className="flex mt-5 justify-between">
          <p className="ml-2 text-gray-500">Humidity</p>
          {data && <p className="mr-5 text-gray-800">{data.main.humidity}%</p>}
        </div>

        <div className="flex mt-5 justify-between">
          <p className="ml-2 text-gray-500">Wind Speed</p>
          {data && <p className="mr-5 text-gray-800">{data.wind.speed}m/sec</p>}
        </div>
      </div>
    </div>
  );
